#ifndef _JIT_COMPILER_BRAINFUCK_IR
#define _JIT_COMPILER_BRAINFUCK_IR
          ...
          switch(currentToken) {
            ...
            case Token::JUMP_IF_NON_ZERO: {
              if(backPatchingHelper.size() == 0) {
                ...
                cerr<<"No previous JUMP_IF_ZERO token for the current JUMP_IF_NOT_ZERO token"<<endl;
                exit(1);
              }
...
#endif _JIT_COMPILER_BRAINFUCK_IR
